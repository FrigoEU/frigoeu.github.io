 ...
 */  
  ...
  var update$prime = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 128, column 1 - line 128, column 84: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var getPosition = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 208, column 1 - line 209, column 1: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var getClass = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 204, column 1 - line 205, column 1: " + [ v.constructor.name ]);
  };
  ...
  var render = function (ctx) {
      return function (dims) {
          return function (pstate) {
              return function __do() {
                  Control_Monad_Eff_Console.logShow(Data_Show.showNumber)(pstate.x)();
                  ...
                  (function () {
                      var $102 = Data_Eq.eq(eqShape)(getShape(pstate.move))(Square.value);
                      if ($102) {
                      ...
                      throw new Error("Failed pattern match at Main line 257, column 3 - line 276, column 11: " + [ $102.constructor.name ]);
                  })()();
  ...
  var nextInCycle = function ($167) {
      return Data_Maybe.fromMaybe(Red.value)(Data_Enum.succ(enumColor)($167));
  };
  ...
  var update = function (v) {
      return function (v1) {
          ...
          var $141 = canReflect(v1.move)(v.value1);
          if ($141) {
              var $142 = {};
              for (var $143 in v1) {
                  if (v1.hasOwnProperty($143)) {
                      $142[$143] = v1[$143];
                  };
              };
              $142.direction = opposite(v1.direction);
              $142.move = v.value1;
              return $142;
          };
          if (!$141) {
          ...
          throw new Error("Failed pattern match at Main line 116, column 35 - line 118, column 43: " + [ $141.constructor.name ]);
      };
  };
  var botDecision = function (pstate) {
      return function (v) {
          return function (v1) {
              ...
              if (v instanceof L) {
                  var $150 = pstate.x < Data_Newtype.unwrap(newtypeSeed)(v1.xseed) * 50.0 - 5.0;
                  if ($150) {
                  ...
                  throw new Error("Failed pattern match at Main line 293, column 42 - line 295, column 56: " + [ $150.constructor.name ]);
              };
              if (v instanceof R) {
                  var $153 = pstate.x > 100.0 - (Data_Newtype.unwrap(newtypeSeed)(v1.xseed) * 50.0 + 5.0);
                  if ($153) {
                      return new Data_Maybe.Just(randomCorrectMove(v1.moveseed)(pstate.move));
                  };
                  if (!$153) {
                  ...
                  throw new Error("Failed pattern match at Main line 296, column 42 - line 298, column 56: " + [ $153.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 292, column 1 - line 292, column 78: " + [ pstate.constructor.name, v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  ...
  /**
 *  Optimizations
 *  Multiple canvasses, multiple states, use refEq to rerender or not
 */  
  var main = function __do() {
      ...
      var dispatch = function (act) {
          return function __do() {
              var $168 = Control_Monad_Eff_Ref.readRef(v7)();
              return Control_Monad_Eff_Ref.writeRef(v7)(update(Debug_Trace.spy(act))($168))();
          };
      };
      var dispatch$prime = function (act) {
          return function __do() {
              var $169 = Control_Monad_Eff_Ref.readRef(v7)();
              return Control_Monad_Eff_Ref.writeRef(v7)(update$prime(act)($169))();
          };
      };
